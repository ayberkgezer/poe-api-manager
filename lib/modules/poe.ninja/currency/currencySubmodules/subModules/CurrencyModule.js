...
class CurrencyModule extends CurrencyBaseClass {
   ...
   * @param {string} currencyId - The ID of the currency to fetch data for. Defaults to "Divine Orb".
   ...
   */
  async getQuickCurrency(currencyId = "Divine Orb") {
    try {
      return await getQuickCurrency(this.#league, this.#typeName, currencyId);
    } catch (error) {
